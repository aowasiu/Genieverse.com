...
<!--Genieverse Custom CSS -->
	...
	<script <?php if($_SERVER['HTTP_HOST'] == 'www.genieverse.com'){ ?>src="//cdn.ckeditor.com/4.5.3/standard/ckeditor.js"<?php } else{ ?>src="../../Server_Includes/API_and_plug_ins/ckeditor/ckeditor.js"<?php } ?>>
<?php	/*	var editor = CKEDITOR.replace(description);
