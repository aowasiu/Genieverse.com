<?php
	...
	if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] == "Log in")
	{
		...
		{
			$_SESSION["errand"] = "You didn't enter your password or username";
		}
		elseif(strlen($password) > 15)
		{
			$_SESSION["errand"] = "Your password is longer than 15 characters.";
		}
		else {
				...
				{
					$_SESSION["errand"] = "Your username and password don't match any member's detail.";
				}
				else {
