...
<!--Genieverse Custom CSS -->
	...
	<?php
		if(isset($ckeditor))
		{ ?>
	<script <?php if($_SERVER['HTTP_HOST'] == 'www.genieverse.com'){ ?> src="//cdn.ckeditor.com/4.5.3/standard/ckeditor.js" <?php }else{ ?> src="Server_Includes/scripts/ckeditor/ckeditor.js" <?php	} ?> "></script>
	<?php
	}
	?>
	...
	<?php } ?>
		...
		<?php if($_SERVER['HTTP_HOST'] == 'www.genieverse.com'){ ?><script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.pack.js"></script>
		<?php }else{ ?>
