<?php
	...
	//Get footer script
	require_once('outer_pages_common_footer.php');
...
<head>
	...
	else{	?><link href="../../API_and_plug_ins/bootstrap-3.3.5-dist/css/bootstrap.min.css" rel="stylesheet">
	<?php
	} ?>
<!--Genieverse Custom CSS -->
	...
	{
	?><link href="../../../css/bootstrap_custom_css/stylish-portfolio.css" rel="stylesheet">
