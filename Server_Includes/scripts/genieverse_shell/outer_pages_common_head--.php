<?php
	...
	require_once('Server_Includes/scripts/genieverse_shell/outer_pages_common_footer.php');
...
<!--Genieverse Custom CSS -->
	...
	<?php
		if(isset($ckeditor))
		{ ?>
    <?php if($_SERVER['HTTP_HOST'] == 'www.genieverse.com'){ ?><script src="//cdn.ckeditor.com/4.5.3/standard/ckeditor.js"><?php }else{ ?><script src="../../../Server_Includes/scripts/ckeditor/ckeditor.js"><?php } ?>
		var editor = CKEDITOR.replace(description);
		var editor = CKEDITOR.replace(barter);
    </script>
	<?php } ?>
	<?php
/*		if(isset($ckeditor))
		{ ?>
	<script <?php if($_SERVER['HTTP_HOST'] == 'www.genieverse.com'){ ?> src="//cdn.ckeditor.com/4.5.3/standard/ckeditor.js" <?php }else{ ?> src="Server_Includes/scripts/ckeditor/ckeditor.js" <?php } ?>>
	var editor = CKEDITOR.replace(description);
	var editor = CKEDITOR.replace(barter);
</script>
	<?php
