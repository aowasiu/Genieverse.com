<?php
	...
	$search_keywords = (isset($_POST["search_keywords"])) ? trim($_POST["search_keywords"]) : "Type search terms here";
	$safe_search_words mysql_real_escape_string($search_keywords);
	
	if($safe_search_words == "")
	{
		$no_search_result = "You didn't enter any word to search for";
	}
	else {
			...
			$not_needed_match = 'voice_post_id, voice_post_view_count, voice_category_id, ';
