		...
		<form role="form" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
			<div class="form-group col-lg-12">
				<div class="row">
					<div class="col-md-9">
						<h4>Name</h4>
						<input type="text" maxlength="30" class="form-control" name="name" value="<?php echo $name; ?>">
					</div>
					<div class="col-md-3">
						<h4>Gender</h4>
			...
			<div class="form-group col-lg-12">
				<div class="row">
					<div class="col-md-6">
						<h4>About me</h4>
						<textarea name="about_me" id="about_me" rows="150" class="form-control" ><?php echo $about_me; ?></textarea>
					...
					<div class="col-md-6">
						...
						<select class="form-control" name="age" id="age">
						   <?php
							for($x=$minimum_age; $x<$maximum_age; $x++)
							{
								echo '<option ';
								if(isset($age) && $age == "$x")
						...
						<h4>Phone</h4>
						<input type="text" maxlength="<?php echo $maximum_phone_length; ?>" class="form-control" name="phone" value="<?php echo $phone; ?>">
						<h4>Email</h4>
				...
				<div class="row">
					<div class="col-md-4">
						<h4>City</h4>
						<input type="text" maxlength="<?php echo $max_length_city; ?>" class="form-control" name="city" value="<?php echo $city; ?>">
					</div>
					<div class="col-md-4">
						<h4>State</h4>
						<input type="text" maxlength="<?php echo $max_length_state; ?>" class="form-control" name="state" value="<?php echo $state; ?>">
					</div>
					<div class="col-md-4">
						<h4>Upload photo </h4>
			...
			<div class="form-group col-lg-12">
				<div class="row text-center">
					<div class=" col-md-8 col-md-offset-2 text-center">
						...
						<br/><br/>
						<input class="btn btn-info" type="submit" name="submit" value="<?php echo $submit_button; ?>">
					</div>
				</div>
			</div>
