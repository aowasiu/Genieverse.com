<?php
	...
	$query = 'SELECT mall_post_id, mall_category_id, mall_post_price, cc_id, mall_category_id, mall_post_title, mall_post_description, mall_post_state, mall_post_city, mall_post_created_on FROM gv_mall_post WHERE (mall_member = 1 AND mall_post_block = 0) ORDER BY mall_post_id DESC ';
	...
	$extra_title = "Recent posts | Genieverse Mall - Free web market ";	
...
<?php
			...
			?>
            <div class="col-md-4 portfolio-item">
                <p>Sorry. There're no recent posts.</p>
			</div><?php
	}?>
        </div>
		<!-- /.row -->
