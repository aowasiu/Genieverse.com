...
<?php	require_once('Server_Includes/scripts/genieverse_shell/outer_pages_header1.php');	?>
    ...
    <div class="container">
		...
		<div class="caption-full">
			...
			<h1>Genieverse Privacy Policy</h1>
			<p>This privacy policy sets out how Genieverse uses and protects any information that you give when you use this website.</p>
			<p>Genieverse is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement.</p>
			<p>Genieverse may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective from Sunday, October 25th, 2015.</p>
			<b>What we collect</b>
			<p>We may collect the following information:</p>
			<ul>
			<li>name, bio-data, and employment information</li>
			...
			<p>We may retain your personal information, even if you deactivate your account. We do this in the event you're under investigation by security agencies or authorities and that the inquirer has a court order to that effect.</p>
			<b>How we use cookies</b>
			<p>A cookie is a small file which asks permission to be placed on your computer's hard drive. Once you agree, the file is added and the cookie helps analyse web traffic or lets you know when you visit a particular site. Cookies allow web applications to respond to you as an individual. The web application can tailor its operations to your needs, likes and dislikes by gathering and remembering information about your preferences.</p>
			<p>We use traffic log cookies to identify which pages are being used. This helps us analyse data about web page traffic and improve our website in order to tailor it to
			...
			prefer. This may prevent you from taking full advantage of the website.</p>
			...
			following ways:</p>
			<ul>
			<li>whenever you are asked to fill in a form on the website, look for the box that
			you can click to indicate that you do not want the information to be used by
			anybody for direct marketing purposes</li>
			...
			emailing us at <b>complaint@Genieverse.com</b></li>
			</ul>
			...
			you may find interesting if you tell us that you wish this to happen.</p>
