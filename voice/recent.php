<?php
	...
	$query = 'SELECT voice_post_id, voice_category_id, cc_id, voice_post_created_on, voice_post_title, voice_post_body, voice_post_state, voice_post_city FROM gv_voice_post WHERE (voice_member = 1 AND voice_post_block = 0) ORDER BY voice_post_id DESC ';
	...
	//Set extra title
	$extra_title = "Recent Loud Voice posts | Genieverse Voice - Tell the world what's happening. ";
	...
	//Set Recent link active in navigation
	$recent = "set";
