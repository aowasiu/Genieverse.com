<?php
	...
	$query = 'SELECT voice_post_id, cc_id, voice_category_id, voice_post_title, voice_post_body, voice_post_state, voice_post_city, voice_post_settled_on FROM gv_voice_post WHERE (voice_member = 1 AND voice_post_block = 0) AND (voice_post_settlement = 0 AND loud_voice = 1) ORDER BY voice_post_id DESC ';
	...
	//Set this page's link active
	$special = "set";

	//Set extra title
	$extra_title = "Loud Voices | Genieverse Voice - Tell the world what's happening.";
...
<?php require_once('../Server_Includes/scripts/voice_scripts/voice_outer_page_header.php'); ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><small>Loud Voices</small></h1>
            </div>
        </div>
        <!-- /.row -->
...
?><div class="col-md-4 portfolio-item">
		...
		echo modified_for_url($row["voice_post_title"], "&post="); ?>"><?php echo $row["voice_post_title"]; ?></a></h4>
			...
			?>
            <div class="col-md-4 portfolio-item">
                <p>Sorry. There're no Loud Voice posts.</p>
			</div><?php
	}?>
        </div>
		<!-- /.row -->
