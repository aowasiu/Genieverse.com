...
//	$country_id				=	(isset($_POST["country_id"]))	?	$_POST["country_id"] : "";
	...
	if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] == "Create post")
	{
		...
		if(count($errors) < 1)
		{
			...
			$query = 'INSERT INTO gv_voice_post
					(voice_post_id, voice_member, voice_post_block, voice_post_settlement, voice_post_settled_on, voice_post_assessment, voice_post_assessed_by, voice_post_assessed_on, voice_post_created_on, voice_post_edited_on, cc_id, member_id, voice_category_id, voice_post_youtube, voice_post_title, voice_post_body, voice_post_state, voice_post_city, voice_post_contact_name, voice_post_contact_phone, voice_post_contact_email, voice_post_contact_website)
					VALUES
	...
	$extra_title = "New " . ucfirst($category_name) . " post | Genieverse Voice - Tell the world what's happening. ";
	$shop_item = "set";
