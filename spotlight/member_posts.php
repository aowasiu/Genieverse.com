<?php
	...
	$query = 'SELECT spotlight_post_id, spotlight_category_id, cc_id, spotlight_post_created_on, spotlight_post_title, spotlight_post_body, spotlight_post_state, spotlight_post_city FROM gv_spotlight_post WHERE (spotlight_member = 1 AND spotlight_post_block = 0) AND (member_id = ' . $get_id . ')ORDER BY spotlight_post_id DESC ';
	...
	$extra_title = member_username($get_id) . "'s posts | Genieverse Spotlight - " . $spotlight_meta_description;	
