...
<p class="col-sm-12 col-md-12 col-lg-12">Posted by: <a href="../member_profile.php?id=<?php echo $row["member_id"]; ?>"><b><?php echo $the_poster; ?></b></a></p>
						...
						<br>
						<p class="col-lg-4" style="text-align: center;"><b><a class="btn btn-default" href="comments.php?id=<?php echo $row["spotlight_post_id"]; ?>">View All Comments</a></b></p>
						<p class="col-lg-4" style="text-align: center;"><b><a class="btn btn-default" href="comments.php?id=<?php echo $row["spotlight_post_id"]; ?>">Post a Comment</a></b></p>
						<p class="col-lg-4" style="text-align: center;"><b><a class="btn btn-default" href="../thanks_for_reporting.php?id=<?php echo $row["spotlight_post_id"]; ?>&db=spotlight">Report this post</a></b></p>
                    </div>
                </div>
			</div>
